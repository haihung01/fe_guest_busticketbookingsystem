    ...
    return (
        <footer className="bg-white" style={{ backgroundColor: '#F9F2F2' }}>
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                        ...
                        <div className='mt-16'>
                            ...
                            <div className='mt-8'>
                                <div className='flex mt-4 space-x-6'>
                                    <span>DOWNLOAD THE FUTA APP</span>
                                    <div className="flex space-x-6 md:mt-8 ">
                ...
                <div className="px-4 py-6 bg-gray-100 dark:bg-green-800 md:flex md:items-center md:justify-center">
