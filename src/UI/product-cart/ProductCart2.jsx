                                ...
                                <section>
                                    <Container>
                                        ...
                                        <Row className="w-[700px] h-[350px] border border-gray-200 rounded-2xl shadow-xl overflow-auto mt-4     ">
                                            <div className="flex">
                                                <Col>
                                                    <h1 className="ml-6 mt-3 text-lg font-medium">Thông tin khách hàng</h1>
                                                ...
                                                <Col>
                                                    <h1 className="text-center justify-center mt-3 text-xl text-orange-500">ĐIỀU KHOẢN & LƯU Ý</h1>
                                                    <div className='ml-6 flex-col mt-3'>
                                                        <br />
                                                        <span >
                                                            (*) Quý khách vui lòng có mặt tại bến xuất phát của xe trước ít nhất 30 phút giờ xe khởi hành, mang theo thông báo đã thanh toán vé thành công có chứa mã vé được gửi từ hệ thống TripTix.
                                                        </span>
                                                        <br /><br />
                                                        <span>(*) Nếu quý khách có mọi thắc mắc, có thể vào phần Liên Hệ của nhà xe yêu cầu tư vấn hỗ trợ.</span>
                                                    </div>
                                                </Col>
                                            </div>
                                            <Col className="mt-2 ml-6">
                                                ...
                                                >
                                                    Chấp nhận các điều khoản đặt vé & chính sách bảo mật thông tin của TripTix.
                                                </label>
                                            </Col>
                                        </Row>

                                        <Row className="w-[700px] h-[170px] border border-gray-200 rounded-2xl shadow-xl overflow-auto mt-2">
                                            <h1 className="ml-6 mt-3 text-lg font-medium">Thông tin đón trả</h1>
