                                        ...
                                        <Container>
                                            <Row className='flex gap-9'>
                                                <Col className=''>
                                                    ...
                                                    <Col>
                                                            <div className="w-[300px] h-[40px] rounded-3xl flex bg-orange-500 mt-5 justify-center  relative text-gray-50">
                                                                <button
                                                                    onClick={handleButtonClick}
                                                                    className="font-sans w-[200px] h-[40px]"
                                                ...
                                                <Col className='w-[700px] h-[640px] border border-gray-200 rounded-2xl shadow-xl    '>
                                                    ...
                                                    <div className='ml-6 flex flex-col mt-3'>
                                                        <div>
                                                            <img
                                                            alt='img'
                                                            className='w-[650px] h-[200px]'
                                                            src='https://scontent.xx.fbcdn.net/v/t1.15752-9/385525600_2267895093410289_12196275034908805_n.png?stp=dst-png_p206x206&_nc_cat=111&ccb=1-7&_nc_sid=510075&_nc_eui2=AeEBZGajT1MZxvlsMd2eBPblYRS1vk3pBvxhFLW-TekG_NHyrWkyfK6GVztx_PXC7I4FWqU93pM-wRLx8_3kFYrN&_nc_ohc=olvlqnkK0cIAX8gng9v&_nc_ad=z-m&_nc_cid=0&_nc_ht=scontent.xx&oh=03_AdQnk8u1Aj9vlyjh23XpD06OYveYzr62F0WIaM0eZuM3iQ&oe=65A928C6' />
                                                            <br></br>
                                                            <img
                                                            alt='img'
                                                                className='mt-7 w-[650px] h-[250px]'
