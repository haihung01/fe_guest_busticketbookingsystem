            ...
            <div className="flex w-[360px] min-w-[360px] flex-col bg-[#F8F9F9] stroke-[#EBEDEE] text-[15px] font-medium sm:rounded-xl">
              ...
              <div class="p-4">
                ...
                >
                  <label class="ant-checkbox-wrapper mt-2">
                    ...
                    <span>
                      <span class="ml-1 font-normal">Sáng sớm 00:00 - 06:00 </span>
                    </span>
                  </label>
                  <label class="ant-checkbox-wrapper mt-2">
                    <span class="ant-checkbox">
                      <input type="checkbox" class="ant-checkbox-input" value="2" />
                      <span class="ant-checkbox-inner"></span>
                    </span>
                    <span>
                      <span class="ml-1 font-normal">Buổi sáng 06:00 - 12:00</span>
                    </span>
                  </label>
                  <label class="ant-checkbox-wrapper mt-2">
                    <span class="ant-checkbox">
                      <input type="checkbox" class="ant-checkbox-input" value="3" />
                      <span class="ant-checkbox-inner"></span>
                    </span>
                    <span>
                      <span class="ml-1 font-normal">Buổi chiều 12:00 - 18:00</span>
                    </span>
                  </label>
                  <label class="ant-checkbox-wrapper mt-2">
                    <span class="ant-checkbox">
                      <input type="checkbox" class="ant-checkbox-input" value="4" />
                      <span class="ant-checkbox-inner"></span>
                    </span>
                    <span>
                      <span class="ml-1 font-normal">Buổi tối 18:00 - 24:00</span>
                    </span>
                  </label>
                </div>
              ...
              <div class="p-4">
                ...
                <div class="mt-4 flex flex-wrap gap-2">
                  ...
                  <div class="cursor-pointer rounded-md border bg-white py-1 px-3 text-[14px] font-normal border-[#DDE2E8]">Hàng cuối</div>
                </div>
              </div>
            </div>
          </div>
          <div class="flex w-full flex-col">
            ...
            <div class="mb-2 flex w-full flex-col border border-[#DDE2E8] bg-white p-3 pb-4 sm:mb-6 sm:rounded-xl sm:p-6">
              ...
              <div class="text-yellow mt-1 text-[13px] sm:w-1/2">
                <span class="underline">Lưu ý</span>: Quý Khách đang chọn tuyến xe có
                lộ trình đi Cao Tốc- Long Thành - Dầu Giây - Phan Thiết. L
            ...
            <div class="mb-2 flex w-full flex-col border border-[#DDE2E8] bg-white p-3 pb-4 sm:mb-6 sm:rounded-xl sm:p-6">
              ...
              <div class="text-yellow mt-1 text-[13px] sm:w-1/2">
                <span class="underline">Lưu ý</span>: Quý Khách đang chọn tuyến xe có
                lộ trình đi Cao tốc Phan Thiết Dầu Giây. Lưu ý không nhậ
                <span class="ml-1 cursor-pointer lowercase">
                  <span class="text-orange">...Xem thêm</span>
                </span>
              </div>
